...
class CreatedHomeUseCaseTest {
    ...
    void creacionDeGrupoExitosa() {
        var creator = Person.restore(UUID.randomUUID(), "Carlos", "Ruiz", "carlos@mail.com", "hashed", LocalDateTime.of(2026, Month.JANUARY, 1, 10, 0, 0), true);
    ...
    void nombreVacioNoCrearElGrupo() {
        ...
        when(personRepositoryPort.getUserByEmail("carlos@mail.com")).thenReturn(
            Optional.of(Person.restore(UUID.randomUUID(), "Carlos", "Ruiz", "carlos@mail.com", "hashed", LocalDateTime.of(2026, Month.JANUARY, 1, 10, 0, 0), true))
        );
    ...
    void hogarConNombreYaExistenteLanzaExcepcion() {
        var home = Home.create(UUID.randomUUID(), "Los García", LocalDateTime.of(2026, Month.JANUARY, 1, 10, 0, 0));
